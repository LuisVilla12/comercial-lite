...
<x-app-layout>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
        ...
        @endforeach
        @foreach ($sucursales as $sucursal)
            <x-dashboard-card href="{{ route('facturas.index', $sucursal) }}" bg="bg-teal-50 dark:bg-teal-900/20"
                title="Facturas {{ $sucursal->nombre }}" desc="Generar facturas" iconBg="bg-teal-500">
                <x-slot:icon>
