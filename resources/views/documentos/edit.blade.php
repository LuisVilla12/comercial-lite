    ...
    "
                    ...
                    "
                                        ...
                                        <div class="lg:hidden space-y-4">
                                            <template x-for="(item, index) in items" :key="index">
                                                <div
                                                    class="bg-white  dark:bg-slate-800 border shadow rounded p-4 space-y-3">
                                    ...
                                    <div @click.stop
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <select x-model="p.precioSeleccionado" x-init="if (!p.precioSeleccionado) p.precioSeleccionado = String(p.costo)"
                                                ...
                                                <option x-show="Number(p.costo2) > 0" :value="String(p.costo2)">$<span
                                                        x-text="p.costo2"></span></option>
                                                @if (auth()->user()->isAdmin())
                                                    <option x-show="Number(p.costo3) > 0" :value="String(p.costo3)"><span
                                                            x-text="p.costo3"></span></option>
                                                    <option x-show="Number(p.costo4) > 0" :value="String(p.costo4)">$<span
                                                            x-text="p.costo4"></span></option>
                                                    <option x-show="Number(p.costo5) > 0" :value="String(p.costo5)">$<span
                                                            x-text="p.costo5"></span></option>
                                                @endif
