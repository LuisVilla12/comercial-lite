...
@section('title', content: 'Editar un método de pago')
...
<x-app-layout>
    ...
    <form id="formPago" method="POST" action="{{ route('metodos.update',$medio) }}" class="">
    @csrf
    @method('PUT')
 ...
 <div class="md:col-span-2 lg:col-span-1 mb-2">
        ...
        <div class="mb-2">
            <label class="block text-md font-medium text-gray-700 mb-1">
                Nombre del metodo de pago: <span class="text-red-500">*</span>
            </label>
