<x-app-layout>
    ...
    <div class="text-right mt-6 space-y-1">
        ...
        <p class="uppercase block text-lg font-medium mb-2 dark:text-white">IVA: ${{ number_format($compra->impuestos,
            2) }}</p>
    ...
    <div class="mt-6 flex gap-4">
        <div class="md:col-span-2 flex justify-between gap-3 mt-4">
            ...
            @if ($compra->estatus == 1)
            <a href="{{ route('compras.edit',$compra) }}" class="px-6 py-2 bg-green-600 hover:bg-green-700 text-white  rounded-md font-medium">
                Actualizar compra
            </a>
            @endif
        </div>
