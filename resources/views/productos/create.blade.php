@section('title', content: 'Registrar producto')
        ...
        <form method="POST" action="{{ route('productos.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3  lg:grid-cols-4 gap-4">
                ...
                <div class="">
                    ...
                    <input name="clave_producto" placeholder="Clave" value="{{ old('clave_producto') }}"
                ...
                <div class="">
                    ...
                    <input name="codigo_producto" placeholder="Codigo" value="{{ old('codigo_producto') }}"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="mb-1">
                    ...
                    <select name="valor_clasificacion1" id="valor_clasificacion1"
                        ...
                        @foreach ($clasificaciones as $clasificacion)
                            <option value="{{ $clasificacion->id }}" @selected(old('valor_clasificacion1') == $clasificacion->id)>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="mb-1">
                    ...
                    <input type="number" name="precio2" value="{{ old(key: 'precio2') }}" placeholder="Precio 2"
                        step="0.01"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div class="mb-1">
                    ...
                    <input type="number" name="precio3" value="{{ old(key: 'precio3') }}" placeholder="Precio 3"
                        step="0.01"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                {{-- Precio 4 --}}
                <div class="mb-1">
                    ...
                    <input type="number" name="precio4" value="{{ old(key: 'precio4') }}" placeholder="Precio 4"
                        step="0.01"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                {{-- Precio 5 --}}
                <div class="mb-1">
                    ...
                    <input type="number" name="precio5" value="{{ old(key: 'precio5') }}" step="0.01"
                ...
                <div class="mb-1">
                    ...
                    <input type="number" name="precio_calculado" value="{{ old(key: 'precio_calculado') }}"
                ...
                <div class="mb-1">
                    ...
                    <input type="number" name="retencion1" value="{{ old(key: 'retencion1') }}"
                ...
                <div class="mb-1">
                    ...
                    <input type="number" name="importe_extra" value="{{ old(key: 'importe_extra') }}"
