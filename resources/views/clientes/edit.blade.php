...
<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 mt-6">
        ...
        <form method="POST" action="{{ route('clientes.update', $cliente->id) }}" class="">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div class="mb-1">
                    ...
                    <input type="text" name="curp" value="{{ $cliente->curp }}"
                        class="p-2 w-full uppercase rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div class="mb-1">
                    ...
                    <input type="email" name="email1" value="{{ $cliente->email1 }}"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    @error('email1')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-1">
                    ...
                    <input type="email" name="email2" value="{{ $cliente->email2 }}"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div class="mb-2 md:mb-0">
                    ...
                    <input type="number" name="credito" value="{{ $cliente->credito }}" placeholder="Monto de credito"
                        min="0"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                {{-- DIAS DE CREDITO --}}
                <div class="mb-2 md:mb-0">
                    ...
                    <input type="number" name="diasCredito" value="{{ $cliente->diasCredito }}" min="0"
            ...
            <div class="md:col-span-2 flex justify-between gap-3 mt-4">
                ...
                <div x-data @keydown.window.prevent.f9="$refs.btnRegistrar.click()">
                    <button x-ref="btnRegistrar" type="submit"
