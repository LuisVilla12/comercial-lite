@section('title', content: 'Editar promoción')
...
<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto bg-white shadow-md rounded-lg p-6 mt-6">
        <form id="formAlmacen" method="POST" action="{{ route('promociones.update',$promocion) }}" class="">
            @method('PUT')
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-4">
                 <div class="md:col-span-2 lg:col-span-1 mb-2">
                    ...
                    <input type="text" name="codigo" placeholder="Codigo" value="{{ $promocion->codigo }}"
                ...
                <div class="md:col-span-2 lg:col-span-1 mb-2">
                    ...
                    <input type="text" name="name" placeholder="Nombre" value="{{ $promocion->nombre }}"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    @error('name')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="valor" placeholder="Valor de la promocion:" value="{{ $promocion->valor }}"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    @error('valor')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-2">
                    ...
                    <input type="date" name="fecha_inicio" placeholder="Valor de la promocion:" value="{{ $promocion->fecha_inicio }}"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    @error('fecha_inicio')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-2">
                    ...
                    <input type="date" name="fecha_fin" placeholder="Valor de la promocion:" value="{{ $promocion->fecha_fin }}"
                        class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    @error('fecha_fin')
                        <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    @enderror
