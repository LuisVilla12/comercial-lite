@section('title', 'Registrar pago')
    <x-app-layout>
        ...
        <form method="POST" action="{{ route('pagos.store') }}" x-data="compraApp()"
            x-init="init();">
    ...
    "
                        ...
                        <div class="col-span-full">
                            <label class="block text-lg font-medium mb-2 dark:text-white">Facturas pendientes: </label>
