...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200">
            Catálogo de entradas de almacén
        </h2>
    </x-slot>
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 my-4">
        ...
        <div x-data @keydown.window.prevent.f9="$refs.btnEntrada.click()">
            {{-- Botón --}}
            <a href="{{ route('ajustes-almacen.create',$tipo=1) }}"
                x-ref="btnEntrada"
    ...
    <div class="shadow-md overflow-x-auto rounded-lg">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700">
                                    <div class="flex justify-center items-center gap-4">
                                        ...
                                        @if ($entrada->estatus == 1)
                                            ...
                                            {{-- Editar --}}
                                            <a href="{{ route('entradas.edit', [ 'entrada' => $entrada]) }}"
                                            ...
                                            {{-- Eliminar --}}
                                            <form
                                                action="{{ route('entradas.destroy', ['entrada' => $entrada]) }}"
        ...
        @else
            <div class="bg-white py-4 mt-3">
                <p class="text-sm text-gray-600 ml-6 text-center"> No hay entradas</p>
            </div>
        @endif
        @if ($entradas->count() > 0)
