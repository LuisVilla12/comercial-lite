        ...
        <div x-data="{ sidebar: true, inventario: false,catalogos:false,operaciones:false, administracion:false}" class="flex h-screen">
            ...
            <aside :class="sidebar ? 'w-60' : 'w-20'"
                ...
                <nav class="flex-1 p-3 space-y-2 overflow-y-auto">
                    ...
                    <!-- Ventas -->
                    <div>
                        <a href="{{ route('cotizaciones.index', $sucursal) }}" class="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-slate-800">
                            <x-heroicon-o-document-text class="w-5 h-5" />
                            <span x-show="sidebar">
                                Cotizaciones
                            </span>
                        </a>
                        <a href="{{ route('remisiones.index', $sucursal) }}" class="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-slate-800">
                        ...
                        <a href="{{ route('facturas.index', $sucursal) }}" class="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-slate-800">
                            <x-heroicon-o-clipboard-document-list class="w-5 h-5" />
                            <span x-show="sidebar">
                                Facturas
                            </span>
                        </a>
                        <a href="{{ route('devoluciones.index', $sucursal) }}" class="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-slate-800">
