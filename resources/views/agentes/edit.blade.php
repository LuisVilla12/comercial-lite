...
<x-app-layout>
    ...
    <form id="formAgente" method="POST" action="{{ route('agentes.update', $agente) }}" class="">
        @csrf
        @method('PUT')
 ...
 <div class="md:col-span-2 lg:col-span-1 mb-2">
            ...
            <input type="text" name="codigo"
                   placeholder="Codigo"
                   value="{{ $agente->codigo??old('codigo') }}"
        ...
        <div class="mb-2">
            ...
            <input type="text" name="nombre"
                   ...
                   value="{{ $agente->nombre??old('nombre') }}"
                   class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
             @error('nombre')
            <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
            @enderror
        ...
        <div class="mb-2">
            ...
            <input type="text" name="apellidoP"
                   ...
                   value="{{ $agente->apellidoP??old('apellidoP')   }}"
                   class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
            @error('apellidoP')
            <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
            @enderror
        ...
        <div class="mb-2">
            ...
            <input type="text" name="apellidoM"
                   ...
                   value="{{ $agente->apellidoM??old('apellidoM') }}"
                   class="p-2 w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500">
            @error('apellidoM')
            <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
            @enderror
